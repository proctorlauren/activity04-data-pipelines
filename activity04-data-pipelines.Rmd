...
**Response**: The TRUE function includes coding and talks about what the code is doing.
...
**Response**: Major, unemployment_rate. In excel, I would probably create a bar graph or some type of chart to visualize the lowest unemployment rate per major. 
...
**Response**: Early Childhood Education has the highest proportion of women at 0.9690.
